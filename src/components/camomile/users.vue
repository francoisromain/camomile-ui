<template>
  <div v-if="adminIs">
    <div class="flex flex-start">
      ...
      <button @click="popupOpen({ userId: null, closeBtn: true, title: 'Add user', component: popupUserEdit })" class="flex-right btn p-s"><i class="icon-24 icon-24-plus"></i></button>
    </div>
    <div>
